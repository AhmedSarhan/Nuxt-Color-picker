<template>
  <v-container class="color-picker-section" elevation-5>
    ...
    <v-btn
      color="error"
      class="d-block white--text my-4 mx-auto my-3"
...
export default {
  ...
  methods: {
    addColor() {
      ...
      let addedColors = this.shadePalette.filter((color) => {
      ...
      if (
        ...
        this.feedback = 'This Color name is not valid'
        return false
      } else if (this.colorName === null) {
        this.feedback = 'Please Enter a Valid Color name First'
        return false
      } else if (dublicateColors.length > 0) {
        this.feedback =
          "The Name of this Color is Already Taken, let's Try something else"
        return false
      }
    },
    generateRandomColors() {
      ...
      for (let i = 0; i <= this.shadePalette.length; i++) {
        let randomColor =
